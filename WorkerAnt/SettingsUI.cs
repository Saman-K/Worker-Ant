...
namespace WorkerAnt
{
    public partial class SettingsUI : Form
    {
        ...
        private void SettingsUILoad(object sender, EventArgs e)
        {
            ...
            // load user preferred
            (checkBoxAudioAlert.Checked, checkBoxSimpleView.Checked, checkBoxAutoStart.Checked, checkBoxBreakStretches.Checked) = GetSetSettingsData.GetSettingsUserPreferences();
        }
        #endregion
        ...
        private void SaveBtn(object sender, EventArgs e)
        {
            ...
            GetSetSettingsData.SaveSettings(numUDWorkRecovery.Value, numUDBreakRecovery.Value, numUDWorkSmart.Value, numUDBreakSmart.Value,
                numUDWorkProgress.Value, numUDBreakProgress.Value, numUDRound.Value, checkBoxAudioAlert.Checked, checkBoxSimpleView.Checked, checkBoxAutoStart.Checked, checkBoxBreakStretches.Checked), "Worker Ant Settings", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1);
        }
        #endregion
    }
}
